...
groovy -cp $WORKING_MODULE_DIRECTORY/ scripts/FunctionPipelineUtility.groovy initialize || exit 1 

#Controlling the stages of the deployment
#groovy -cp $WORKING_MODULE_DIRECTORY/ scripts/FunctionPipelineUtility.groovy configDeployment || exit 1 
