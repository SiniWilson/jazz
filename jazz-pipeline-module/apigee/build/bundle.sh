...
Build(){
    ...
    sed "/Header/s/'LambdaFunctionName'>[^<]*</'LambdaFunctionName'>$functionName</" cf_AWSLambdaFunctionName.xml > tempFunctionName.xml
    sed "/Header/s/'EnvironmentName'>[^<]*</'EnvironmentName'>$environmentID</" tempFunctionName.xml > finalFunctionName.xml
    rm cf_AWSLambdaFunctionName.xml
    rm tempFunctionName.xml
    mv finalFunctionName.xml cf_AWSLambdaFunctionName.xml
    cat cf_AWSLambdaFunctionName.xml
